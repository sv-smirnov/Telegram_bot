...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    @Query("select t from Task t where t.startedAt between :startDate and :endDate and t.user.id = :user_id")
    List<Task> historyBetween(LocalDate startDate, LocalDate endDate, Long user_id);
